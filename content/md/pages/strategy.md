...
### 1. **Invest** according to your current investment criteria.
### 2. **Analyze losses in detail**---find out what happened, why it went wrong, and use AI tools to accelerate the process.
### 3. **Update your criteria** if there is an actionable lesson.
### 4. **Repeat.**
